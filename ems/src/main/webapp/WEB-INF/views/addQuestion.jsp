		...
		<form action="addQuestionForm" method="get">
			...
			<div class="form-group">
				<label>Question Type</label> <select class="form-control"
					...
					<c:forEach var="type" items="${allQuestionType}">
				...
				<div class="form-check  form-check-inline">
					<p id="correctAns">
						<input class="form-check-input" type="radio" name="correctAnswer"
							id="option1" value="1"> <label class="form-check-label">1</label>
						<input class="form-check-input" type="radio" name="correctAnswer"
							id="option2" value="2"> <label class="form-check-label">2</label>
					</p>
				</div>
			</div>
			<div class="text-center">
