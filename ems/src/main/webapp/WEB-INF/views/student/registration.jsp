...
<body>
	<div class="container">
		<form:form action="registrationForm" method="post" modelAttribute="student">
			...
			<div class="form-group">
				<input name="higherEducation" type="text" placeholder="Higher Education"
					class="form-control" />
			...
			<div class="form-group">
				<input name="higherEducationCertificate" type="text" placeholder="Higher Education Certificate"
					class="form-control" />
				<form:errors path="higherEducationCertificate" cssClass="error"/>	
			</div>
			
			<div class="form-group">
				<input name="registrationDate" type="text" placeholder="Registration Date"
					class="form-control" />
